...
if ($gender == "male") {
    $result = 88.362 + (13.397 * $weight) + (4.799 * $height) - (5.677 * $age); // BMR calculation result for man
    echo "BMR: $result\n";
}

if ($gender == "female") {
    $result = 447.593 + (9.247 * $weight) + (3.098 * $height) - (4.330 * $age); // BMR calculation result for man
    echo "BMR: $result\n";
}

if ($guess > $result) { // Check guess vs BMR
